...

{
  ...
  elseif(strpos($text, "/start") === 0 && strlen($text)>6 )
  {	  
	//new parser:
	$url_to_parse = $text_url_array[1];
...
function set_referral_URL($url){
	$referral = array("tk0f6-21","tk0f6-21","tk0f6-21","tk0f6-21");
	$random = mt_rand(0,3);
...
function parse_text($string){
	...
	$string3 = str_replace("/start", "", $string2);
